...
\specialfunc{require,library, head}
...
\begin{tikzpicture}[scale=2]
	...
	\node[fblock,align=center] (aX12)  at (3.25, 0) {$X_{1,2}$};
	\node[block,align=center] (aX13)  at (3.75, 0) {$X_{1,3}$};
	...
	\node[fblock,align=center] (aX22)  at (3.25, -.5) {$X_{2,2}$};
	\node[block,align=center] (aX23)  at (3.75, -.5) {$X_{2,3}$};
	...
	\node[fblock,align=center] (aX32)  at (3.25, -1) {$X_{3,2}$};
	\node[block,align=center] (aX33)  at (3.75, -1) {$X_{3,3}$};
	...
	\node[fblock,align=center] (aXi2)  at (3.25, -1.75) {$X_{i,2}$};
	\node[block,align=center] (aXi3)  at (3.75, -1.75) {$X_{i,3}$};
	...
	%line
	\draw[line width=1pt, dashed] (2.25,.25) -- node [anchor=center, fill=white,align=center,rotate=90] {Filter = [ , 3]} (2.25,-2) ;
\end{tikzpicture}
\caption{Planning and workflow} \label{fig:schemaFilterFrame}
\end{figframe}
\end{figure}
