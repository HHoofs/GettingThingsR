...
\begin{theo}[Pakketen installeren en activeren]
...
\begin{theo}[Definering werkmap opnemen in syntax]
...
<<settings2, include=FALSE>>=
options(max.print=20)
@

<<label="BrackDiamantenMultiple", tidy=FALSE, highlight=TRUE, warning=FALSE, comment=NA>>=
...
<<label="BrackDiamantenOrder", tidy=FALSE, highlight=TRUE, warning=FALSE, comment=NA>>=
...
<<settings3, include=FALSE>>=
options(max.print=100)
@

<<label="BrackDiamantenRow5", tidy=FALSE, highlight=TRUE, warning=FALSE, comment=NA>>=
diamanten[1:5,]
@

Of de 1\textsuperscript{e}, 10\textsuperscript{e}, 100\textsuperscript{e}, en de 1000\textsuperscript{e} rij:
<<label="BrackDiamantenRow110", tidy=FALSE, highlight=TRUE, warning=FALSE, comment=NA>>=
...
Hier worden dus rij 20 t/m 25 geselecteerd voor de variabelen \texttt{color} \& \texttt{table}.
