...
Zoals we in het voorgaande hoofdstuk hebben kunnen zien, is het niet nodig om elementen te defineren met een standaardwaarde. Als een dergelijk element niet wordt gedefineerd zal de functie immers deze standaardwaarde gebruiken om de functie uit te voeren. Ook bij de functies \func{head} en \func{tail} maakten we in het kookboek gebruik van deze 
