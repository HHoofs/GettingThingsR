...
\specialterms{R,RStudio,foreign,diamanten,karakter,object,Usage,Inf,factor,numerieke,vector,element,logisische constanten,functie,Hmisc,matrix,data.frame,numeriek,lijst}
...
\specialfunc{require,library,read.spss,head,tail,ncol,nrow,dim,str,colnames,identical,subset,summary,rcorr
}
...
op <- options(str = strOptions(strict.width = "cut"))
...
\centering
\begin{tikzpicture}[scale=2, font=\sffamily]
%  \draw[black] (-.7,.7) rectangle (5.6,-1.6);
