...
In principe is dit ook wat \term{R} daadwerkelijk doet. Het kijkt welke positie de genoemde variabele in het dataframe heeft, en selecteerd de overeenkomstige kolom. In Figuur \ref{fig:schemaFilterFrame} is te schematisch weergegeven hoe zojuist beschreven filter werkt. 
